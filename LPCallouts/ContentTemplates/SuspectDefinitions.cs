...
public class Suspects
{
	...
	public static void GenerateContent()
	{
		try
		{
			...
			#region Dialogs
			string name = "~b~" + Globals.CharacterName + ":~w~ ";
			string suspect = "~r~Suspect:~w~ ";
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 1,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D01[0], // Hello. Do you own the vehicle in your driveway?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D01[1], // Yes, officer, I do.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D01[2], // Okay. Can you tell me where you were about 15 minutes ago?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D01[3], // Am I being detained, officer?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D01[4], // I'm only asking you where you were. Can you tell me that, or should I come back with a warrant?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D01[5], // Well, what's happening? Is there a problem with my vehicle?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D01[6], // Yes. It matches the description of a vehicle involved in a Hit and Run.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D01[7], // Well, I was home all day. Your source must have a misunderstanding or something.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D01[8], // Can I take a closer look at your vehicle?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D01[9], // Ugh, you got me. I hit the person and drove off, I didn't know what to do. I'm so sorry, don't arrest me please!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D01[10], // Okay, well I have to take you down to the station. Put your hands where I can see them, please.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 1,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D01[11], // Fuck this! I ain't going back to jail.
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 2,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D02[0], // Hey there. Is that your vehicle in the driveway?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D02[1], // Yes, it is. Is everything okay?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D02[2], // Can you tell me where you were about 15 minutes ago?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D02[3], // Can you tell me what is going on? Do I need a lawyer?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D02[4], // Your vehicle matches the description of a vehicle involved in a Hit and Run.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D02[5], // Bullshit! I was home all day!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D02[6], // Okay. We can sort this out at the station. Currently, you are being detained and will have to come down to the station with me.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D02[7], // No! I'm not doing that!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D02[8], // Well unfortunately, at this point, you have no choice.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D02[9], // Stupid cops, stupid justice system. Go screw yourself!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D02[10], // Okay. Go ahead and put your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 2,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D02[11], // Screw this! Try to catch me pig!
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 3,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D03[0], // Is that your vehicle in the driveway?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D03[1], // Hello Officer. Yes, it is.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D03[2], // Any reason for so much vehicle damage?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D03[3], // I got in an accident a few days ago. It's in the process of being fixed, officer.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D03[4], // Oh, okay. Did you happen to get in an accident today?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D03[5], // No, I wasn't involved in an accident today. Why do you ask?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D03[6], // This vehicle matches the description of a vehicle involved in a hit and run. And by the way you're talking, I can tell you are nervous. Want to come clean?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D03[7], // I am clean. I didn't get in an accident. Please leave now. You aren't welcomed at my home.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D03[8], // The charge isn't that severe. If you come clean, you might get a lesser sentence. Last chance, do you want to come clean?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D03[9], // Ugh, fine! The person got in my way. I couldn't stop in time. It wasn't my fault, officer, it was theirs...
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D03[10], // Okay. We can sort it out at the station. Right now you are being detained. Put your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 3,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D03[11], // I'm not going back to jail! Stupid pig!
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 4,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D04[0], // Hello. Do you have a minute? I would like to ask you some questions.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D04[1], // No, sorry. I'm in a hurry!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D04[2], // I am assuming you know why I am here. Can you tell me why you have so much front end damage on your vehicle?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D04[3], // As I said, I don't have time! Please leave!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D04[4], // I am not leaving until you answer my question. Why is there so much damage to your vehicle?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D04[5], // Because some bastard hit me, and now you are going to arrest me, when they caused it!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D04[6], // Well, due to you admitting to me you were just involved in a hit and run, you will need to come down to the station for further questioning.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D04[7], // No, I am staying right here.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D04[8], // No, you aren't. Please, don't make me have to use force. Put your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D04[9], // This isn't fair!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D04[10], // Last chance. Put your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 4,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D04[11], // No, this isn't fair I said!
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 5,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D05[0], // Do me a favor and keep your hands where I can see them. Is that your vehicle parked over there?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D05[1], // ..Yes officer, it is. Is everything alright?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D05[2], // Can you tell me where you were approximately 20 minutes ago?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D05[3], // Can you tell me why you're acting like a dick?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D05[4], // Okay. Would you like to tell me where you were, or should I take you down to the station until our investigation is over?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D05[5], // I was cruising around! I was enjoying my day off and just got done pulling in. What the hell is going on?!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D05[6], // Did you happen to hit someone while you were out?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D05[7], // What?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D05[8], // Don't act like nothing has happened. Last chance, did you hit a person?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D05[9], // Maybe. I would like to talk to my lawyer.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D05[10], // You can, down at the station. Right now, you are under arrest for a Hit and Run. Keep your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Default,
				_dialogid = 5,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D05[11], // Fuck you, bitch. Catch me if you can!
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 6,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D06[0], // Hello. Do you own the boat anchored over there?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D06[1], // Yes, officer, I do.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D06[2], // Okay. Can you tell me where you were about 15 minutes ago?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D06[3], // Am I being detained, officer?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D06[4], // I'm only asking you where you were. Can you tell me that, or should I come back with a warrant?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D06[5], // Well, what's happening? Is there a problem with my boat?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D06[6], // Yes. It matches the description of a watercraft involved in a Hit and Run.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D06[7], // Well, I was home all day. Your source must have a misunderstanding or something.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D06[8], // Can I take a closer look at your boat?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D06[9], // Ugh, you got me. I hit the person and sped off, I didn't know what to do. I'm so sorry, don't arrest me please!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D06[10], // Okay, well I have to take you down to the station. Put your hands where I can see them, please.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 6,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D06[11], // Fuck this! I ain't going back to jail.
			});
			// --- DIALOG 7 ---
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 7,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D07[0], // Hey there. Is that your boat anchored over there?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D07[1], // Yes, it is. Is everything okay?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D07[2], // Can you tell me where you were about 15 minutes ago?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D07[3], // Can you tell me what is going on? Do I need a lawyer?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D07[4], // Your boat matches the description of a watercraft involved in a Hit and Run
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D07[5], // Bullshit! I was home all day!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D07[6], // Okay. We can sort this out at the station. Currently, you are being detained, and will have to come down to the station with me.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D07[7], // No! I am not doing that!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D07[8], // Well unfortunately, at this point, you have no choice.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D07[9], // Stupid cops, stupid justice system. Go screw yourself.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D07[10], // Okay. Go ahead and put your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 7,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D07[11], // Screw this. Try to catch me pig!
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 8,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D08[0], // Is that your boat anchored over there?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D08[1], // Hello Officer. Yes, it is.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D08[2], // Any reason for so much damage to your boat?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D08[3], // I got in an accident a few days ago. It's in the process of being fixed, officer.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D08[4], // Oh, okay. Did you happen to get in an accident today?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D08[5], // No, I wasn't involved in an accident today. Why do you ask?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D08[6], // Your boat matches the description of a watercraft involved in a hit and run. And by the way you're talking, I can tell you are nervous. Want to come clean?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D08[7], // I am clean. I didn't get in an accident. Please leave now. I don't want to answer any more questions.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D08[8], // The charge isn't that severe. If you come clean, you might get a lesser sentence. Last chance, do you want to come clean?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D08[9], // Ugh, fine! The person got in my way. I couldn't stop in time. It wast my fault, officer, it was theirs...
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D08[10], // Okay. We can sort it out at the station. Right now you are being detained. Put your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 8,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D08[11], // I'm not going back to jail! Stupid pig!
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 9,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D09[0], // Hello. Do have a minute? I would like to ask you some questions.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D09[1], // No, sorry. I'm in a hurry!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D09[2], // I am assuming you know why I am here. Can you tell me why you have so much front end damage on your boat?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D09[3], // As I said, I don't have time! Please leave!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D09[4], // I am not leaving until you answer my question. Why is there so much damage to your boat?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D09[5], // Because some bastard got in front of me, and now you are going to arrest me, when they caused it!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D09[6], // Well due to you admitting to me you were just involved in a hit and run, you will need to come down to the station for further questioning.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D09[7], // No, I am staying right here.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D09[8], // No, you aren't. Please, don't make me have to use force. Put your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D09[9], // This isn't fair!.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D09[10], // Last chance. Put your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 9,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D09[11], // No, this isn't fair I said!
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 10,
				_counter = 0,
				_text = name + SuspectDialogueTranslation.D10[0], // Do me a favor and keep your hands where I can see them. Is that your boat over there?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 1,
				_text = suspect + SuspectDialogueTranslation.D10[1], // ..Yes officer, it is. Is everything alright?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 2,
				_text = name + SuspectDialogueTranslation.D10[2], // Can you tell me where you were approximately 20 minutes ago?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 3,
				_text = suspect + SuspectDialogueTranslation.D10[3], // Can you tell me why you're acting like a dick?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 4,
				_text = name + SuspectDialogueTranslation.D10[4], // Okay. Would you like to tell me where you were, or should I take you down to the station until our investigation is over?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 5,
				_text = suspect + SuspectDialogueTranslation.D10[5], // I was cruising around! I was enjoying my day off and just got done pulling in. What the hell is going on?!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 6,
				_text = name + SuspectDialogueTranslation.D10[6], // Did you happen to hit someone while you were out?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 7,
				_text = suspect + SuspectDialogueTranslation.D10[7], // What?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 8,
				_text = name + SuspectDialogueTranslation.D10[8], // Don't act like nothing has happened. Last chance, did you hit a person?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D10[9], // Maybe. I would like to talk to my lawyer.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 10,
				_text = name + SuspectDialogueTranslation.D10[10], // You can, down at the station. Right now, you are under arrest for a Hit and Run. Keep your hands where I can see them.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._Water,
				_dialogid = 10,
				_counter = 11,
				_text = suspect + SuspectDialogueTranslation.D10[11], // Fuck you, bitch. Catch me if you can!
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 11,
				_counter = 0,
				_text = SuspectDialogueTranslation.D11[0], // Hey partner, looks like you found the car I was looking for.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._NoSuspect,
				_dialogid = 11,
				_counter = 1,
				_text = SuspectDialogueTranslation.D11[1], // Hi, yeah, i was doing my patrol round when i saw it there.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._NoSuspect,
				_dialogid = 11,
				_counter = 2,
				_text = SuspectDialogueTranslation.D11[2], // Anything that could lead us to a suspect?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._NoSuspect,
				_dialogid = 11,
				_counter = 3,
				_text = SuspectDialogueTranslation.D11[3], // Sorry, no. There was nobody on the way up here and nothing in the car.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._NoSuspect,
				_dialogid = 11,
				_counter = 4,
				_text = SuspectDialogueTranslation.D11[4], // Damn. Well you can leave i will take car about the rest.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._NoSuspect,
				_dialogid = 11,
				_counter = 5,
				_text = SuspectDialogueTranslation.D11[5], // Ok thanks, see ya.
			});
			...
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				...
				_dialogid = 12,
				_counter = 0,
				_text = SuspectDialogueTranslation.D12[0], // Hey Partner, seems the BOLO brought success.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 1,
				_text = SuspectDialogueTranslation.D12[1], // Hi, yes, i stopped the car because of its damage to the front wheel, and then saw the APB.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 2,
				_text = SuspectDialogueTranslation.D12[2], // Yeah, well i will take over from here ok ?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 3,
				_text = SuspectDialogueTranslation.D12[3], // Sure, i will back you up from here.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 4,
				_text = SuspectDialogueTranslation.D12[4], // Thanks, then lets go
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 5,
				_text = SuspectDialogueTranslation.D12[5], // Please step out of the vehicle.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 6,
				_text = /*suspect +*/ SuspectDialogueTranslation.D12[6], // No, what did i do wrong? Why did you stop me?
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 7,
				_text = SuspectDialogueTranslation.D12[7], // Your car is seriously damaged. You can't continue. Please step out!
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 8,
				_text = SuspectDialogueTranslation.D12[8], // The Vehicle you drive has been stolen and was involed in a Hit and Run. You are under arrest. Show me you hands.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 9,
				_text = suspect + SuspectDialogueTranslation.D12[9], // I would like to talk to my lawyer.
			});
			SuspectDialogs.Add(new Globals.SuspectDialog
			{
				_callouttype = Globals.CalloutType._TrafficStop,
				_dialogid = 12,
				_counter = 10,
				_text = suspect + SuspectDialogueTranslation.D12[10], // Seeya bitches!
			});
			#endregion Dialogs
