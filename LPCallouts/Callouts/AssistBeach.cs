                    ...
                    case Globals.PlayerState.TO_WITNESS:
                        if (_dispatched == false)
                        {
                            GameFiber.StartNew(delegate
                            {
                                ...
                                GameHandler.DispatchMessage(/*"10-4. Showing you 10-76. Respond to {0} Code 2."*/AssistBeachTranslation.TEXT[3].Replace("{0}", $"~y~ { _street} ~w~"));
            ...
            if (Rage.Game.IsKeyDown(GameHandler.ini_action))
            {
                ...
                switch (_mlog_loop2)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        GameHandler.PlayerChat(5, Dialog, GameHandler.ini_displaytime);
                        _mlog_loop2 = 2;
                        break;
                    case 2:
                        GameHandler.PlayerChat(1, Dialog, GameHandler.ini_displaytime);
            ...
            if (Rage.Game.IsKeyDown(GameHandler.ini_action))
            {
                ...
                switch (_mlog_loop4)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        GameHandler.PlayerChat(3, /*"I believe it was a */AssistBeachTranslation.TEXT[7] + " ~y~" + color1 + "/" + color2 + Dialog, GameHandler.ini_displaytime);
                        GameFiber.Wait(1000);
                        _mlog_loop4 = 4;
                        break;
                    case 4:
                        ...
                        break;
                    case 5:
                        GameHandler.PlayerChat(3, Dialog + _suspect_location._areaname, GameHandler.ini_displaytime);
                        GameFiber.StartNew(delegate
                        {
                            GameFiber.Wait(2000);
